...
<head>
    ...
    <link rel="stylesheet" href="vendor/lte/bower_components/bootstrap/dist/css/bootstrap.min.css">
...
<body>
    ...
    <section class="invoice">
        <div class="row">
            <div class="col-xs-12">
                <img style="margin-right: 40px" src="assets/img/logo.png" alt="" class="img-responsive pull-left" width="100">
                <div class="ml-4" style="margin-left: 110px">
