                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <div class="pull-right">
                                    <div class="box-title">
                                        <a href="<?php echo base_url('laporan/export_persiswa/' . $this->input->get('id_pembayaran') . '/' . $this->input->get('id_kelas') ) ?>" class="btn btn-success"><i class="fas fa-sign-out-alt"></i> Export Excel</a>
